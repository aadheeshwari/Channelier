...
const data = [
  {
    image_url: "https://award-test.arachnomesh.com/static/media/benefit_1.de1ab640eb926f5023bf.webp",
    text: 'Awards trophy',
    headtext: 'Pride',
  },
  {
    image_url: "https://award-test.arachnomesh.com/static/media/benefit_2.e6e536b1f2271ef62bbf.webp",
    text: 'Certificate of excellence',
    headtext: 'Promotion',
  },
  {
    image_url: "https://award-test.arachnomesh.com/static/media/benefit_3.44855cbc816e3eca0cc9.webp",
    text: 'Digital seal',
    headtext: 'Prestige',
  },
  {
    image_url: "https://award-test.arachnomesh.com/static/media/benefit_4.a9f19ae497d070da2588.webp",
    text: 'Coffee table book',
    headtext: 'Motivation',
  },
];
const blob_colors = ['#FFBF00', '#FAB900', '#F5B400', '#F0AE00',  '#EBA900','#E6A300','#E19E00','#DC9800','#D79300','#D28D00','#CD8800','#C88200','#C37D00' ];
    ...
    <div className='benefitmain' id='benefit'>
      ...
      >
        ...
        <img
          ...
          src={item.image_url}
          alt={`benifit ${index + 1}`}
          style={{ animationPlayState: animation ? 'running' : 'paused' }}
        />
        <h4>{item.text}</h4>
      </div>
    )
